...
grep -q 'unified-delay: true' templates/mihomo/edge.yaml
grep -q 'tcp-concurrent: true' templates/mihomo/edge.yaml
grep -q 'enhanced-mode: fake-ip' templates/mihomo/edge.yaml
